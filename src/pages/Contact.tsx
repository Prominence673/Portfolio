...
export default function Contact() {
  return (
    <>
      ...
      <section
        id="contact"
        className="min-h-screen flex flex-col justify-center items-center px-10 py-20 bg-zinc-50/50"
      >
        <motion.div
        ...
        <div className="flex flex-col gap-12 w-150 max-w-6xl">
          <motion.div
            ...
            <div>
              ...
              <div className="space-y-4">
                <a
                  ...
                  className="flex items-center gap-4 p-4 bg-white rounded-xl border border-zinc-200 shadow-sm hover:shadow-md transition-all duration-300 group"
                >
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-zinc-600">
                      www.linkedin.com/in/lautaro-souza-3069a5398/
                    </p>
                  </div>
                </a>
              </div>
